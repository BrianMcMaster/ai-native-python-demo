...
[![CI](https://github.com/BrianMcMaster/ai-native-python-demo/actions/workflows/commit.yml/badge.svg)](https://github.com/BrianMcMaster/ai-native-python-demo/actions/workflows/commit.yml)
...
# Run the image
docker run BrianMcMaster/ai-native-python-demo:0.0.0 --help
```
