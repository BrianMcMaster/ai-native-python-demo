# Claude Instructions for ai-native-python-demo
...
- **Name**: ai-native-python-demo
- **Package**: ai_native_python_demo
- **Description**: Let\\'s Vibe
- **Organization**: Brian McMaster (brianmcmaster.com)
- **Python Version**: 3.13+
...
```
ai_native_python_demo/    # Main package code
...
### Error Handling
```python
class AiNativePythonDemoError(Exception):
    """Base exception for ai-native-python-demo."""
    pass

class ConfigurationError(AiNativePythonDemoError):
...
4. Follow Brian McMaster coding standards
